...
export const OPPORTUNITY_CARDS: OpportunityCard[] = [
  ...
  // ── 小生意：ETF / 债券 / REITs ──
  {
    ...
    description: '跟踪上海黄金现货价格，避险资产配置。按手交易（1手=100份）。',
    type: 'opportunity',
    kind: 'smallDeal',
    asset: {
      id: 'gold_etf_asset',
  ...
  },
  {
    id: 'vending_machine',
    title: '自动售货机',
    description: '在商场/学校投放自动售货机，每月稳定零售收入。',
    type: 'opportunity',
    kind: 'smallDeal',
    asset: {
      id: 'vending_machine_asset',
      name: '自动售货机',
      type: 'entity',
      cost: 12000,
      downPayment: 3000,
  ...
  {
    id: 'power_bank_cabinet',
    title: '共享充电宝机柜',
    description: '在餐饮店投放共享充电宝机柜，靠租借费持续盈利。',
    type: 'opportunity',
    kind: 'smallDeal',
    asset: {
      id: 'power_bank_cabinet_asset',
      name: '共享充电宝机柜',
      type: 'entity',
      cost: 8000,
      downPayment: 2000,
  ...
  },
  {
    id: 'online_course',
    title: '在线课程版权',
    description: '买断一套优质在线课程版权，挂在知识平台持续获得分成收入。',
    type: 'opportunity',
    kind: 'smallDeal',
    asset: {
      id: 'online_course_asset',
      name: '在线课程版权',
      type: 'intellectual',
      cost: 10000,
      downPayment: 2000,
  ...
  {
    id: 'self_service_laundry',
    title: '自助洗衣房',
    description: '小区布设自助洗衣机/洗鞋机，低成本运营持续收钱。',
    type: 'opportunity',
    kind: 'smallDeal',
    asset: {
      id: 'self_service_laundry_asset',
      name: '自助洗衣房设备',
      type: 'entity',
      cost: 8000,
      downPayment: 2000,
